...
struct ContentView: View {
    ...
    Finally, a note on privacy. Cue uses your microphone and Apple's speech recognition. Audio is processed locally when on-device recognition is available, and never stored. Your scripts stay on your machine. The window itself can be made invisible to screen recording and screen sharing, so you can rehearse during a video call without your audience seeing the prompter.
